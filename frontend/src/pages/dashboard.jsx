          ...
          <div className="col-lg-3">
            <div className="card border-0 rounded-4 p-3 shadow" style={{ backgroundColor: '#161a2d' }}>
              <div className="text-center mb-4">
                <div className="rounded-circle bg-primary d-inline-flex align-items-center justify-content-center mb-3 shadow" style={{ width: '80px', height: '80px', fontSize: '24px', color: 'white' }}>
                  JD
                </div>
            ...
            {activeTab === 'bidding' ? (
                  ...
                  <table className="table table-dark table-hover mb-0">
                    <thead>
                      <tr className="text-white-50">
                        ...
                        <th className="pe-4 py-3 text-end border-secondary">Action</th>
                      </tr>
                    </thead>
                    <tbody>
                      <tr className="align-middle border-secondary">
                        <td className="ps-4">
                          <div className="d-flex align-items-center gap-3 py-2">
                            <img src="https://placehold.co/50x50/png?text=Naruto" className="rounded-2 shadow-sm" alt="" />
                            <span className="small fw-bold">Naruto PVC Figurine</span>
                          </div>
                        </td>
                        <td>$3,200</td>
                        <td className="text-success fw-bold">$3,200</td>
                        <td><span className="badge bg-success rounded-pill px-3">Winning</span></td>
                        <td className="pe-4 text-end"><button className="btn btn-sm btn-outline-light rounded-pill px-3">View</button></td>
                      </tr>
                      <tr className="align-middle border-secondary">
                        <td className="ps-4">
                          <div className="d-flex align-items-center gap-3 py-2">
                            <img src="https://placehold.co/50x50/png?text=Charizard" className="rounded-2 shadow-sm" alt="" />
                            <span className="small fw-bold">Charizard Card PSA 10</span>
                          </div>
                        </td>
                        <td>$125,000</td>
                        <td className="text-danger fw-bold">$120,000</td>
                        <td><span className="badge bg-danger rounded-pill px-3">Outbid</span></td>
                        <td className="pe-4 text-end"><button className="btn btn-sm btn-primary rounded-pill px-3" style={{ backgroundColor: '#4f46e5', border: 'none' }}>Bid Again</button></td>
                      </tr>
                    </tbody>
                  </table>
                </div>
              ...
              <div className="animate__animated animate__fadeIn">
                <div className="d-flex justify-content-between align-items-center mb-4">
                  ...
                  <button className="btn btn-primary fw-bold px-4 rounded-3 shadow" style={{ backgroundColor: '#4f46e5', border: 'none' }}>
                    + Post New Item
                  </button>
                </div>
